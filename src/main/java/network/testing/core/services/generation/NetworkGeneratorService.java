...
import network.testing.core.services.generation.topology.FullGridTopology;
import network.testing.core.services.generation.topology.RandomizedSpanningModifier;
import network.testing.core.services.generation.topology.TopologyGenerator;
import network.testing.core.services.generation.topology.TopologyType;
import network.testing.core.services.generation.weight.PopulationDistributor;
import network.testing.core.services.generation.weight.SuperVertexModifier;
import network.testing.core.services.generation.weight.UniformityModifier;
import network.testing.core.services.generation.weight.WeightDistributor;
...
public class NetworkGeneratorService {
	...
	public NetworkGeneratorService() {
		this.side = 20;
		this.initialize(20, "");
	}
